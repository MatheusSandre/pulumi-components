...
setup(
    ...
    py_modules=["aws_alb", "aws_cloudfront", "aws_cloudwatch", "aws_codebuild", "aws_codepipeline", "aws_codestarnotification",
                "aws_documentdb", "aws_dynamodb", "aws_ec2", "aws_ecr", "aws_ecs", "aws_efs", "aws_elasticache", "aws_iam", "aws_kinesis", "aws_kms",
